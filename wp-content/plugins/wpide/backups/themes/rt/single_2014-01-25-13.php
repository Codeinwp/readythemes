<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f4c1fd392d3"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2014-01-25-13.php") )  ) ){
                        ...
                        <div class="themeright" style="float:right; width:300px; padding-top:20px;">
								...
								<div style="border:1px solid #d5d5d5; background-color:#fff; padding:2px; width:300px; margin-bottom:40px;">
									<div style="background:url(<?php bloginfo('template_directory'); ?>/images/box_bg.gif) repeat-x #E5E5E5; padding:20px;">
										...
										<div style="text-align:center;">
											<input type="image" onClick="_gaq.push(['_trackEvent', 'button_click', 'click_download', 'Tweet Old Post']);_pa.track('downloadclick');" src="http://www.readythemes.com/wp-content/uploads/2012/11/download-free-theme.png" name="Submit" value="Sign Up">
										</div>
