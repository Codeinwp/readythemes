<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "b95bfa8f177a9461f3eff70659660a128b8aa4f535"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/category_2013-09-09-16.php") )  ) ){
					...
					<div id="rnewarchive">
						<div class="arpost">
							...
							<div class="arpcontent">
								<h3><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a><span>$47</span></h3>
