<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f2a268d1b02"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2013-12-27-12.php") )  ) ){
...
<?php while(has_sub_field('who_use_this_theme')):?>
					...
					<li><a rel="nofollow" target="_blank" onclick="_gaq.push(['_trackPageview, '/WhoUseThisTheme']);" href="<?php the_sub_field('website_url') ?>"><img src="<?php the_sub_field('website_screenshot') ?>" alt="" class="prodimage" border="0" /></a><div class="prodheading"><a rel="nofollow" target="_blank" href="<?php the_sub_field('website_url') ?>"><?php $x = get_sub_field('website_url'); $x = substr($x,7); echo rtrim($x,"/"); ?></a></div></li>
				<?php endwhile;?>
				</ul>
				</div>
<?php
