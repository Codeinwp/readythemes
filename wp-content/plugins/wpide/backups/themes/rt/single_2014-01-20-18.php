<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f5b8065dd3e"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2014-01-20-18.php") )  ) ){
				...
				<?php if ( in_category('4')) { ?>
                    ...
                    <div class="themecontent">
                        ...
                        <form name="PaymentForm" id="submitsus" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php" target="_blank">
                                    ...
                                    <div class="buynowbutton" ><a href="#" onclick="document.forms['submitsus'].submit();return false;">Buy now for <?php if ($_GET['coupon']=="war15") echo "<del>37</del> $22"; else if ($_GET['coupon']=="loyal") echo "<del>37</del> $18"; else {?> $37<?php } ?></a><span style="
    color: yellow;
    padding-left: 20px;
    font-style: italic;
				...
				<?php } elseif(in_category('14')) { //PLUGINS 
                    ...
                    <div class="themecontent">
                        ...
                        <form name="PaymentForm" id="submitsus" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php" target="_blank">
                                    ...
                                    <input type="hidden" name="redirect" value="http://www.readythemes.com/thank-you/"/>
                                    <input type="hidden" name="item_name" value="<?php echo $buybutton;?>" />
                                    <div class="buynowbutton" ><a href="#" onclick="document.forms['submitsus'].submit();return false;">Buy now for <?php if ($_GET['coupon']=="war15") echo "<del>17</del> $22"; else if ($_GET['coupon']=="loyal") echo "<del>37</del> $18"; else {?> $9.95<?php } ?></a><span style="
    color: yellow;
    padding-left: 20px;
    font-style: italic;
"> 100% Money Back Guaranteed</span></div>
