...
get_header();
	...
	$home_page_col_1_fixed = $purevision_options['home_page_col_1_fixed'];
	$active_count = $cont_1_is_active + $cont_2_is_active + $cont_3_is_active + $cont_4_is_active;

	if ( $cont_1_is_active || $cont_2_is_active || $cont_3_is_active || $cont_4_is_active ) : // hide this area if no widgets are active...
?>
