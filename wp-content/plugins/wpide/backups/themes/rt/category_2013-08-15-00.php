<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "1ee8d8c18fb33c50796e77fe1d62401df0e3523de0"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/category_2013-08-15-00.php") )  ) ){
	...
	<div id="maincontent" style="padding-top:15px;">
		...
		<?php if (have_posts()) : ?>
			...
			<?php if ( is_category('4')) { ?>
				...
				<?php while (have_posts()) : the_post(); // THEMES ?>	
