<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "4af01ac26a7529d2119e32f822a1dd2c98ca929596"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2014-08-20-12.php") )  ) ){
		...
		<?php if (have_posts()) : ?>
			...
			<div class="fullcontent">
				...
				<?php if ( in_category('4')) { ?>
					...
					<?php if ( is_single('409')||is_single('1142')) { // Ready Review FREE Theme ?>
                    ...
                    <div class="themecontent">
						...
						<h2>
						<?php if ($_REQUEST['ad']=="india") { ?>
						    This is a <span style="color:red">special offer</span> for Indian clients
						<?php } else if ( is_single('409')) { ?>
						    Check-out the PRO version of this theme <a href="http://www.readythemes.com/affiliate-review-plus/?from=free">here</a>.
						<?php }else { ?>
						    
												    Check-out the PRO version of this theme <a href="http://www.readythemes.com/reviewgine-pro/?from=free">here</a>.
                        ...
                        <div class="themeright" style="float:right; width:300px; padding-top:20px;">
                            ...
                            <div style="padding-bottom:10px; margin-bottom:10px;">
                                ...
                                <form name="PaymentForm" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php" target="_blank">
                                    ...
                                    <input type="hidden" name="refferer" value="<?php mysql_real_escape_string($_SESSION['origURL']);?>" />
                            ...
                            <?php } else { ?>
								<div style="border:1px solid #d5d5d5; background-color:#fff; padding:2px; width:300px; margin-bottom:40px;">
									<div style="background:url(<?php bloginfo('template_directory'); ?>/images/box_bg.gif) repeat-x #E5E5E5; padding:20px;">
										...
										<div>
										<!--<span style="font-size:16px; font-weight:bold;">Create a Ready Themes account below and download our FREE affiliate review theme</span>-->
										<p>Create a Ready Themes account below and download our premium affiliate review theme.</p>
										</div>
										...
										<div style="text-align:center;">
											<input type="image" onClick="_gaq.push(['_trackEvent', 'button_click', 'click_download', 'Ready_Review_free']);_pa.track('downloadclick');" src="http://www.readythemes.com/wp-content/uploads/2012/11/download-free-theme.png" name="Submit" value="Sign Up">
										</div>
										
                                        <input type="hidden" name="refferer" value="<?php echo $_SERVER['HTTP_REFERER']; ?>">
                                        <input type="hidden" name="redirect" value="http://www.readythemes.com/thank-you/"/>
                                        <?php //echo is_single('409');?>
                                        <?php if (is_single('409')) { ?>
                    ...
                    <div class="themecontent">
						...
						<div style="text-align:center; margin:30px 0;">
							...
							<h2 class="ptheme" style="font-size:30px;">
							<?php if ( is_single('178')&&$_REQUEST['ad']=="fb") { ?>
							This is a special <span style="color:red">Black Friday</span> deal for US clients
							<?php } ?>
							</h2>
						...
						<div id="rproductlightbox">
							...
							<div class="bigpreview">
								<div class="img"><img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo $imgfoldername;?>/New%20folder/1.jpg" alt=""/></div>
								<div class="img"><img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo $imgfoldername;?>/New%20folder/2.jpg" alt=""/></div>
								<div class="img"><img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo $imgfoldername;?>/New%20folder/3.jpg" alt=""/></div>
							
							</div>
							
							<div class="thumbnails">
								<div class="thumb"><img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo $imgfoldername;?>/New%20folder/11.jpg" alt="" /></div>
								<div class="thumb"><img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo $imgfoldername;?>/New%20folder/22.jpg" alt="" /></div>
								<div class="thumb"><img src="<?php echo get_template_directory_uri(); ?>/images/<?php echo $imgfoldername;?>/New%20folder/33.jpg" alt="" /></div>
							</div>
                        ...
                        <form name="PaymentForm" id="submitsus" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php" target="_blank">
                                    ...
                                    <div class="buynowbutton" ><a href="#" >Buy now for <?php if ($_GET['coupon']=="war15") echo "<del>37</del> $22"; else if ($_GET['coupon']=="loyal") echo "<del>37</del> $18"; else {?> $37<?php } ?></a><span style="
    color: yellow;
    padding-left: 20px;
    font-style: italic;
"> 100% Money Back Guaranteed</span></div>
                        ...
                        <div class="clear"></div>
<?php if(get_field('who_use_this_theme')):
    ?>
    
    <div id="mycarousel1" class="jcarousel-skin-tango">
				<div class="carouselheader" style="font-size:30px;margin-top:30px;font-weight:bold;">Who Is Making Money Using This Theme ?</div>
				<ul>
    

<?php while(has_sub_field('who_use_this_theme')):?>

					<li><a rel="nofollow" target="_blank" onclick="_gaq.push(['_trackEvent', 'whouse', 'click']);" href="<?php the_sub_field('website_url') ?>"><img src="<?php the_sub_field('website_screenshot') ?>" alt="" class="prodimage" border="0" /></a><div class="prodheading"><a rel="nofollow" target="_blank" href="<?php the_sub_field('website_url') ?>"><?php $x = get_sub_field('website_url'); $x = substr($x,7); echo rtrim($x,"/"); ?></a></div></li>
				<?php endwhile;?>
				</ul>
				</div>
<?php
	   ...
	   ?>
						...
						<?php if ($price){ ?>
                        <div class="rsinglerightclass" style="margin-top:40px; margin-bottom:40px; text-align:center;">
                                      <form name="PaymentForm" id="submitsus" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php" target="_blank">
                                    <input type="hidden" name="cmd" value="_xclick"/><?php if(isset($_GET['coupon'])) { ?> <input type="hidden" name="coupon_code" value="<?php echo $_GET['coupon'];?>" /><?php } ?>
                                    <input type="hidden" name="currency_code" value="USD" />
                                    <input type="hidden" name="redirect" value="http://www.readythemes.com/thank-you/"/>
    ...
    padding-bottom: 10px;
    font-style: italic;
"> Unlimited sites license</span></div>
				...
				<?php } elseif(in_category('14')) { //PLUGINS 
					if ( is_single('1407')) { // tweet old post 
					?>
                    ...
                    <div class="themecontent">
						...
						<h2>
						    ...
						    Tweet about your old posts to get more hits for them and keep them alive.
                        ...
                        <div class="themeright" style="float:right; width:300px; padding-top:20px;">
								...
								<div style="border:1px solid #d5d5d5; background-color:#fff; padding:2px; width:300px; margin-bottom:40px;">
									<div style="background:url(<?php bloginfo('template_directory'); ?>/images/box_bg.gif) repeat-x #E5E5E5; padding:20px;">
										...
										<div>
										<!--<span style="font-size:16px; font-weight:bold;">Create a Ready Themes account below and download our FREE affiliate review theme</span>-->
										<p>Create a Ready Themes account below and download our free plugin.</p>
										</div>
										...
										<div style="margin-bottom:10px;">
										<strong>First Name:</strong>
										<input type="text" name="first_name" style="width:240px; padding:8px; border:1px solid #C9C5C5;" pattern="[^(http)]+">
										</div>
										
										<div style="margin-bottom:20px;">
										<strong>Email Address:</strong>
										<input type="email" name="email"  style="width:240px; padding:8px; border:1px solid #C9C5C5;">
										</div>	
										
										<div style="text-align:center;">
											<input type="image" src="http://www.readythemes.com/wp-content/uploads/2012/11/download-free-theme.png" name="Submit" value="Sign Up">
										</div>
					...
					<?php } else	if ( is_single('1421')) { // tweet old post 
					?>
                    ...
                    <div class="themecontent">
						...
						<h2>
						   ...
						   Check-out the PRO version of this plugin <a href="http://www.readythemes.com/wp-product-review-plugin-pro/">here</a>.
                    ...
                    <div class="themecontent">
                        ...
                        <div class="themeright" style="float:right; width:300px; padding-top:0px;">
                        ...
                        <form name="PaymentForm" id="submitsus" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php" target="_blank">
                                    ...
                                    <div class="buynowbutton" ><a href="#">Buy now for <?php if ($_GET['coupon']=="war15") echo "<del>17</del> $22"; else if ($_GET['coupon']=="loyal") echo "<del>37</del> $18"; else {?> $9.95<?php } ?></a><span style="
    color: yellow;
    padding-left: 20px;
    font-style: italic;
"> 100% Money Back Guaranteed</span></div>
