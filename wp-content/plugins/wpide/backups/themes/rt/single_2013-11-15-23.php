<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f26b674bfbc"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2013-11-15-23.php") )  ) ){
			...
			<div class="fullcontent">
				...
				<?php if ( in_category('4')) { ?>
                    ...
                    <div class="themecontent">
						...
						<?php } else { ?>
						    Free Review Theme for Product Reviews
						<?php } ?>
                    ...
                    <div class="themecontent">
                        ...
                        <form name="PaymentForm" id="submitsus" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php" target="_blank">
                                    ...
                                    <div class="buynowbutton" onclick="_gaq.push(['_trackEvent', 'Click cumpara', jQuery(this).text(), window.location.pathname])" ><a href="#" >Buy now for <?php if ($_GET['coupon']=="war15") echo "<del>37</del> $22"; else if ($_GET['coupon']=="loyal") echo "<del>37</del> $18"; else {?><del>47</del> $37<?php } ?></a></div>
