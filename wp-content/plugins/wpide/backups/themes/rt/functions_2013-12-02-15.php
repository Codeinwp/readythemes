<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f10372a320c"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/functions_2013-12-02-15.php") )  ) ){
...
$v = strpos( $_SESSION["origURL"],'warriorforum'); if ($v!==false) { $t='We have a special offer for WarriorForum members <del>67</del> <strong style="color:red;">$55</strong>';}
	else $t='Download Our Entire Theme Collection Only <strong style="color:red;">$55</strong>';
	//	else $t='<strong>Black Friday Deal!</strong> Download All Our Themes For <del>67</del> <strong style="color:red;">$19</strong>';
define('buyall', $t);
