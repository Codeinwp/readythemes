<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f1f0e9ba993"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/dashboard.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/dashboard_2013-11-13-15.php") )  ) ){
...
<a id="wistiaplay" href="http://fast.wistia.net/embed/iframe/64hb0szla6?popover=true" class="wistia-popover[height=853,playerColor=7b796a,width=640]"></a>
                ...
                <?php if( Dap_Session::isLoggedIn() ) { ?>
					...
					<?php } else { // They have bought a single theme or they have the free one so show it ?>
						...
						<?php if (strpos($allprods,'22') == true  ) { //Free Theme signed up within the last 24 hours ?>
							...
							?>
							<!--
							<iframe src="http://fast.wistia.net/embed/iframe/64hb0szla6" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed" name="wistia_embed" allowfullscreen mozallowfullscreen webkitallowfullscreen oallowfullscreen msallowfullscreen width="340" height="453"></iframe>
-->
