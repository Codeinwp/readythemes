<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "4af01ac26a7529d2119e32f822a1dd2c64df3eeae3"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/category_2014-08-27-14.php") )  ) ){
			...
			<?php if ( is_category('4')) { ?>
				...
				<div class="homecontent" style="margin-top:20px;">
					...
					<div class="topblurb">
						...
						?>
					<form name="PaymentForm" target="_blank" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php">
				...
				<?php $i=0; while (have_posts()) : the_post(); // THEMES ?>	
					...
					<?php 
					if ( $post->ID!=1142 && $post->ID!=409 && $post->ID!=81) {
					...
					if ($demo=="http://www.readythemes.com/demo/?theme=Ready%20Review") $price = "FREE"; else $price = "$37";
					?>
