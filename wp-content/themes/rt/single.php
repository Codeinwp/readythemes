...
?>
	...
	<?php if(!in_category(array( 4, 14 ))){ // For blog category, excludes themes and plugins cat9egories ?>
				...
				<?php } elseif(in_category('14')) { //PLUGINS 
                    ...
                    <div class="themecontent">
                        ...
                        <form name="PaymentForm" id="submitsus" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php" target="_blank">
                                    ...
                                    <div class="buynowbutton" ><a href="#">Buy now for <?php if ($_GET['coupon']=="war15") echo "<del>17</del> $22"; else if ($_GET['coupon']=="loyal") echo "<del>37</del> $18"; elseif ( is_single('1519')) {?> $19.95<?php } else { ?>$9.95 <?php } ?></a><span style="
    color: yellow;
    padding-left: 20px;
    font-style: italic;
"> 100% Money Back Guaranteed</span></div>
