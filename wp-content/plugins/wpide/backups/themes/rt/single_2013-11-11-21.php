<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097fda11a1c513"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2013-11-11-21.php") )  ) ){
				...
				<?php if ( in_category('4')) { ?>
                    ...
                    <div class="themecontent">
						...
						<div style="text-align:center; margin:30px 0;">
							...
							<h2><?php  $v = strpos( $_SESSION["origURL"],'warriorforum'); if ($v!==false) {?> Welcome fellow <span style="color:red">Warrior</span>, get this premium theme for FREE <?php } else { ?>Free Review Theme for Product Reviews<?php } ?></h2>
						</div>
                    ...
                    <div class="themecontent">
						...
						<div style="text-align:center; margin:30px 0;">
							<h2 style="font-size:30px;"><?php $v = strpos( $_SESSION["origURL"],'warriorforum'); if ($v!==false) {?> This is a special offer for <span style="color:red">WarriorForum</span> members. <?php } else { ?><?php } ?></h2>
                        ...
                        <form name="PaymentForm" id="submitsus" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php" target="_blank">
                                    ...
                                    <div class="buynowbutton" onclick="_gaq.push(['_trackEvent', 'Click cumpara', jQuery(this).text(), window.location.pathname])" ><a href="#" >Buy now for <?php if ($_GET['coupon']=="war15") echo "<del>37</del> $22"; else if ($_GET['coupon']=="loyal") echo "<del>37</del> $18"; else {?>$37<?php } ?></a></div>
                        ...
                        <div class="rsinglerightclass" style="margin-top:40px; margin-bottom:40px; text-align:center;">
                                    ...
                                    <input type="hidden" name="redirect" value="http://www.readythemes.com/thank-you/"/>
                                    <input type="hidden" name="item_name" value="<?php echo $buybutton;?>" />
                                    <div class="buynowbutton" ><a href="#" onclick="document.forms['submitsus'].submit();return false;">Buy now for <?php if ($_GET['coupon']=="war15") echo "<del>37</del> $22"; else if ($_GET['coupon']=="loyal") echo "<del>37</del> $18"; else {?>$37<?php } ?></a></div>
