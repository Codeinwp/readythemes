<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097fab4312afc3"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2013-10-14-22.php") )  ) ){
				...
				<?php if ( in_category('4')) { ?>
                    ...
                    <div class="themecontent">
                        ...
                        <div class="rsinglerightclass" style="margin-top:40px; margin-bottom:40px; text-align:center;">
                                    ...
                                    <input type="hidden" name="redirect" value="http://www.readythemes.com/thank-you/"/>
                                    <input type="hidden" name="item_name" value="<?php echo $buybutton;?>" />
                                    <div class="buynowbutton" ><a href="#" onclick="document.forms['submitsus'].submit();return false;">Buy now for <?php if ($_GET['coupon']=="war15") echo "<del>37</del> $22"; else {?>$37<?php } ?></a></div>
