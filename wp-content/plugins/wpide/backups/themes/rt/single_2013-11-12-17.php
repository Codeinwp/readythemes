<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f991cfe01a4"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2013-11-12-17.php") )  ) ){
			...
			<div class="fullcontent">
				...
				<?php if ( in_category('4')) { ?>
                    ...
                    <div class="themecontent">
						...
						<div style="text-align:center; margin:30px 0;">
							<h2 class="ptheme" style="font-size:30px;"><?php $v = strpos( $_SESSION["origURL"],'warriorforum'); if ($v!==false) {?> This is a special offer for <span style="color:red">WarriorForum</span> members. <?php } else { ?><?php } ?></h2>
