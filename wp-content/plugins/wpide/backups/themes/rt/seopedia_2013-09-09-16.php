<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "b95bfa8f177a9461f3eff70659660a128b8aa4f535"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/seopedia.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/seopedia_2013-09-09-16.php") )  ) ){
			...
			<div class="homecontent" style="margin-top:20px;">
                ...
                <div class="topblurb">
                    ...
                    <div>
                        ...
                        <span>Download Our Entire Theme Collection Now For Only <strong><strike>$27</strike> &nbsp; $18.9</strong></span> 
