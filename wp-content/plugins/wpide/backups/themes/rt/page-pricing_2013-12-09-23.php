<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "0763d82f91e80708273ebd7d555ea861e1ccb90333"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/page-pricing.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/page-pricing_2013-12-09-23.php") )  ) ){
...
<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo('template_directory'); ?>/style_pricing.css" />
<?php if ( is_home() ) { ?>
...
<body style="background: url(http://www.readythemes.com/wp-content/uploads/2013/12/ready-themes-bg-single.png) repeat-x top #fff;">
...
<!--/header end-->
		...
		<div id="maincontent">
			...
			<div class="heading">
			    Money Making Themes<br/>
			    <span>Ready-made themes for serious affiliate marketers interested in earning money online.  </span>
			</div><!--/heading-->
