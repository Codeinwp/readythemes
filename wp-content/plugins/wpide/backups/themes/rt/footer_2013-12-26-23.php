<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f18a0054311"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/footer_2013-12-26-23.php") )  ) ){
...
jQuery(".buynowbutton a").click(function(){
 var first = function(options, callback) {
	...
	_gaq.push(['_trackEvent', 'Click cumpara', jQuery(this).text(), window.location.pathname]);
