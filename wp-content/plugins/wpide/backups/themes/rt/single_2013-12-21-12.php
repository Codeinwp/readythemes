<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f84ef72a011"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2013-12-21-12.php") )  ) ){
			...
			<div class="fullcontent">
				...
				<?php if ( in_category('4')) { ?>
                    ...
                    <div class="themecontent">
						...
						<?php } else { ?>
						    Check-out the PRO version <a href="http://www.readythemes.com/affiliate-review-plus/?from=free">here</a>.
						<?php } ?>
