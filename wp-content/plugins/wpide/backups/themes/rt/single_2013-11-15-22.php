<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f26b674bfbc"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2013-11-15-22.php") )  ) ){
				...
				<?php if ( in_category('4')) { ?>
                    ...
                    <div class="themecontent">
						...
						<div style="text-align:center; margin:30px 0;">
							...
							Sorry to take you away from Facebook but this is a special Black Friday deal!
							<?php } ?>
							</h2>
