<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "b95bfa8f177a9461f3eff70659660a1254c5c4d8df"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/footer_2013-09-26-12.php") )  ) ){
...
jQuery(".buynowbutton a").click(function(){
 var first = function(options, callback) {
	...
	_gaq.push(['_trackEvent', 'Click cumpara', "xx", "test"]);
