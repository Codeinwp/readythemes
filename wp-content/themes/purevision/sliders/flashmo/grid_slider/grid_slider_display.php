<?php 
	    $gs_image_width = $purevision_options['gs_image_width'];
	    $gs_image_height = $purevision_options['gs_image_height'];
	    $gs_remove_3d_shadow = $purevision_options['gs_remove_3d_shadow'];
?>
		...
		<div id="header-content">
			...
			<div id="flashmo_slider">
			    <img src="<?php echo $purevision_options['gs_no_js_img']; ?>" width="<?php echo $gs_image_width; ?>" height="<?php echo $gs_image_height; ?>" alt="<?php esc_attr_e('Slider Image', 'purevision'); ?>" class="slide-img" />
			</div>
			<!-- grid slider SWF -->
		    </div>
		    <!-- end gs-slideshow -->
