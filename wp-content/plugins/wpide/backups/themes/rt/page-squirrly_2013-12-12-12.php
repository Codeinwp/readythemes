<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f8a62b2fe13"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/page-squirrly.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/page-squirrly_2013-12-12-12.php") )  ) ){
...
<div class="landing_wrap">
			<h1 class="bigheading">ultimate  affiliate wordpress themes collection</h1>
			...
			<div class="small_features"></div>
		 	...
		 	<div class="morethemes">
		 		...
		 		<a href="" class="buynowsmall">Buy Now for $19</a>
