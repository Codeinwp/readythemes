<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2c88b8ab12d80cd45cde7c55cd47ff4ce852dce37a"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/footer_2014-04-20-14.php") )  ) ){
    ...
    <div class="container_12">
        ...
        <div class="grid_3">
            ...
            <p>
				...
				If you are in need of support, please contact us at <a href="mailto:info@readythemes.com">info@readythemes.com</a> and we'll do our best to help.
            </p>
...
jQuery(document).ready(function() {
 ...
 jQuery('.blurbright :image').click(function(e) {
 var $this = jQuery(this);
 var first2 = function(options, callback) {
    //e.preventDefault();
    
	_gaq.push(['_trackEvent', 'Click cumpara themes', jQuery(".blurbright input[name='item_name']").val(), window.location.pathname]);
