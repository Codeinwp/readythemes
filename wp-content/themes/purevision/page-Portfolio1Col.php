...
$portfolio_cat_ID = $purevision_options['portfolio_cat_for_page_'.$page_id]; // Get the portfolio category specified by the user in the 'pureVISION Options' page
...
$portfolio_items_per_page = $purevision_options['portfolio_items_per_page_for_page_'.$page_id];
$portfolio_do_not_link_adjacent_items = $purevision_options['portfolio_do_not_link_adjacent_items_'.$page_id];
$portfolio_title_posistion = $purevision_options['portfolio_title_posistion'];
...
<?php
	    ...
	    if( $portfolio_cat_ID ) :
			...
			<ul>
			    <li><?php esc_html_e('Categories', 'purevision'); ?>: &nbsp;&nbsp;&nbsp;</li>
<?php			    // Generate the link to "All" categories:
			    if ( $current_categoryID ) : ?>
				<li><a href="<?php echo the_permalink(); ?>"><?php esc_html_e('All', 'purevision'); ?></a></li>
<?php			    else : ?>
				<li><a href="<?php echo the_permalink(); ?>" class="current"><?php esc_html_e('All', 'purevision'); ?></a></li>
<?php			    endif;
...
<?php					// Get Portfolio Item Thumbnail
					get_portfolio_item_thumbnail( '2', '420', '230', $portfolio_do_not_link_adjacent_items, true ); ?>
...
<?php
		...
		<div class="grid_22 prefix_1 suffix_1">
		    <h2><?php esc_html_e('Portfolio section for this page has not been found!', 'purevision'); ?></h2>
		    <p><?php _e("<strong>Reason:</strong> No category has been assigned as Portfolio section for this page yet. In order to fix this, go to the theme's options page and assign a category for this page.", 'purevision'); ?></p>
		</div>
<?php
	    endif; ?>
