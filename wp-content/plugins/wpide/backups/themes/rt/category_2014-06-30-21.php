<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2c88b8ab12d80cd45cde7c55cd47ff4ca693e5cead"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/category_2014-06-30-21.php") )  ) ){
...
?>
	...
	<div id="singlefeatured">
		...
		<?php if ( is_category('4')) { ?>
			<h1>Affiliate WordPress Themes</h1>
