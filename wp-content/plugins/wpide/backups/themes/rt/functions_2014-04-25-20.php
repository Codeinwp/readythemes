<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "2c88b8ab12d80cd45cde7c55cd47ff4c43e112f8a6"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/functions_2014-04-25-20.php") )  ) ){
...
$v = strpos( $_SESSION["origURL"],'warriorforum'); if ($v!==false) { $t='We have a special offer for WarriorForum members <del>67</del> <strong style="color:red;">$55</strong>';}
	else $t='Download Our Entire Theme and Collection For Only <strong style="color:red;">$55</strong>';
