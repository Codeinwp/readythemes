<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5bd5295a2d4d672cc65b6b764ecc36c98bfc4e3e6c"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/category_2013-08-30-15.php") )  ) ){
			...
			<?php if ( is_category('4')) { ?>
				...
				<div class="homecontent" style="margin-top:20px;">
					...
					<form name="PaymentForm" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php">
                                    ...
                                    <input type="hidden" name="coupon_code" value="war15">
					...
					<div id="rnewarchive">
						<div class="arpost">
							...
							<div class="arpcontent">
								<h3><a href=""><?php the_title(); ?></a><span>$47</span></h3>

								<p>
									<?php content('55'); ?></p>
								<div class="features">
									<ul>
										<li>Ready Made For Earning Money</li>
									...
									<ul>
										<li>Star Ratings</li>
										<li>Optional Featured Slider</li>
										<li>Custom Menus</li>
