<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f64ab7ff6f8"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/footer_2014-01-26-15.php") )  ) ){
...
jQuery(document).ready(function() {
 ...
 var first2 = function(options, callback) {
	...
	_gaq.push(['_trackEvent', 'Click cumpara xx', jQuery(".blurbright input[name='item_name']").val(), window.location.pathname]);
