<?php
	    ...
	    $pm2_image_width = $purevision_options['pm2_image_width'];
	    $pm2_image_height = $purevision_options['pm2_image_height'];
?>
		...
		<div id="header-content" class="container_24">
			...
			<div id="flashcontent">
			    <img src="<?php echo $purevision_options['pm2_no_js_img']; ?>" width="<?php echo $pm2_image_width; ?>" height="<?php echo $pm2_image_height; ?>" alt="<?php esc_attr_e('Slider Image', 'purevision'); ?>" class="slide-img" />
			    <div class="clear"></div>
			</div>
			<!-- end flashcontent -->
