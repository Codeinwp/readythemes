<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5bd5295a2d4d672cc65b6b764ecc36c99c960bf889"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/warriors.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/warriors_2013-08-29-20.php") )  ) ){
...
<?php get_header(); ?>
		...
		<div id="maincontent">
			...
			<div class="homecontent" style="margin-top:20px;">
                ...
                <div class="topblurb">
                    <div>
                        <span>Download Our Entire Theme Collection Now For Only <strong><strike>$27</strike> &nbsp; $24.30</strong></span> 
                    </div>
                    <div class="clear"></div>
                </div>
