<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f8e8d3b1a05"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2014-02-22-21.php") )  ) ){
			...
			<div class="fullcontent">
				...
				<?php if ( in_category('4')) { ?>
                    ...
                    <div class="themecontent">
						...
						<?php }else { ?>
						    Review Theme That Top Affiliate Marketers Use To Generate Income
						<?php } ?>
...
"> Unlimited sites license</span></div>
				...
				<?php } elseif(in_category('14')) { //PLUGINS 
					...
					<?php } 	if ( is_single('1421')) { // tweet old post 
					?>
