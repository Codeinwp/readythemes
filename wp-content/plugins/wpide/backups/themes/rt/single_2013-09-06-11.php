<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "3637886923acbfbbd6d3719f2eb315639cdf6ac424"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2013-09-06-11.php") )  ) ){
                    ...
                    <div class="themecontent">
						...
						<div id="rproductlightbox">
							<div class="bigpreview">
								<div class="img"><img src="http://www.readythemes.com/wp-content/uploads/2012/09/sniper-theme-display.jpg" alt="" /></div>
								<div class="rdthpreviewbutton"><a href="http://www.readythemes.com/previews/snipertheme/">Live Preview</a></div>
								
							</div><!--/bigpreview-->
							<div class="thumbnails">
								<div class="thumb"><img src="http://www.readythemes.com/wp-content/uploads/2012/09/sniper-theme-display.jpg" alt="" /></div>
								<div class="thumb"><img src="http://www.readythemes.com/wp-content/uploads/2012/09/sniper-theme-display.jpg" alt="" /></div>
								<div class="thumb"><img src="http://www.readythemes.com/wp-content/uploads/2012/09/sniper-theme-display.jpg" alt="" /></div>
							</div><!--/thumbnails-->
                        ...
                        <form name="PaymentForm" id="submitsus" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php" target="_blank">
                                    ...
                                    <input type="hidden" name="currency_code" value="USD" />
                                    <input type="hidden" name="redirect" value="http://www.readythemes.com/thank-you/"/>
                                    <input type="hidden" name="item_name" value="Sniper Theme" />
                                    <div class="buynowbutton" ><a href="#" onclick="document.forms['submitsus'].submit();return false;">Buy now for $<?php if ($_GET['coupon']=="war15") echo "32"; else {?>47<?php } ?></a></div>
...
<input type="hidden" name="currency_code" value="USD" />
<input type="hidden" name="item_name" value="Sniper Theme" />
<div><input type="image" src="http://www.readythemes.com/wp-content/themes/rt/images/buy-now.png" border="0" name="submit" alt="Make payments with PayPal - its fast, free and secure!" /></div>
</form>
                        	<div class="features">
                        ...
                        <div class="themeright" style="float:right; width:300px; padding-top:20px;">
                            ...
                            <div style="padding-bottom:10px; margin-bottom:10px;padding-left:20px">
                                <form name="PaymentForm" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php" target="_blank">
                                   ...
                                   <input type="hidden" name="redirect" value="http://www.readythemes.com/thank-you/"/> <input type="hidden" name="item_name" value="Ready Themes All Access" />
                                    <div><input type="image" src="http://www.readythemes.com/wp-content/themes/rt/images/testgrey.png" border="0" name="submit" alt="Make payments with PayPal - its fast, free and secure!" /></div>
                                </form>
                                <br>
                                <img src="http://www.readythemes.com/wp-content/uploads/2012/07/divider.gif">
