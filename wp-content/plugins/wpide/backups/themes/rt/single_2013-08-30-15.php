<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5bd5295a2d4d672cc65b6b764ecc36c98bfc4e3e6c"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2013-08-30-15.php") )  ) ){
...
<div style="margin-left:20px"><input type="image" src="http://www.readythemes.com/wp-content/themes/rt/images/<?php if ($_GET['coupon']=='war15') echo '15button.jpg';if ($_GET['coupon']=='loyal') echo '23button.jpg'; if ($_GET['coupon']!='war15'&$_GET['coupon']!='loyal') echo 'test.png';?>" border="0" name="submit" alt="Make payments with PayPal - its fast, free and secure!" /></div>                                </form>
                            </div>
