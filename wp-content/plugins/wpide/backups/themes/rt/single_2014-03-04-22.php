<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097fad38df45ca"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2014-03-04-22.php") )  ) ){
				...
				<?php } elseif(in_category('14')) { //PLUGINS 
                    ...
                    <div class="themecontent">
						...
						<h2>
						   ...
						   Easily turn your basic posts into in-depth reviews
