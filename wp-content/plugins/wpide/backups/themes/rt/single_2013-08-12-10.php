<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "1ee8d8c18fb33c50796e77fe1d62401d83c0a50991"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2013-08-12-10.php") )  ) ){
                    ...
                    <div class="themecontent">
                        ...
                        <div class="themeright" style="float:right; width:300px; padding-top:20px;">
                            ...
                            <div style="padding-bottom:10px; margin-bottom:10px;">
								...
								<a href="https://www.jvzoo.com/b/0/10699/14"><img src="http://www.readythemes.com/wp-content/uploads/2012/07/download-all-themes.png" alt="Ready Themes All Access" border="0" /></a>
                                <br>
								...
								<div style="border:1px solid #d5d5d5; background-color:#fff; padding:2px; width:300px; margin-bottom:40px;">
									<div style="background:url(<?php bloginfo('template_directory'); ?>/images/box_bg.gif) repeat-x #E5E5E5; padding:20px;">
										...
										<div style="text-align:center;">
											<input type="image" onClick="_gaq.push(['_trackEvent', 'button_click', 'click_download', 'Ready Review free']);" src="http://www.readythemes.com/wp-content/uploads/2012/11/download-free-theme.png" name="Submit" value="Sign Up">
										</div>
