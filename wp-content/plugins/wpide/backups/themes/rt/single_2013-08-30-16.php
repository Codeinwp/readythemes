<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5bd5295a2d4d672cc65b6b764ecc36c98bfc4e3e6c"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/single_2013-08-30-16.php") )  ) ){
				...
				<?php if ( in_category('4')) { ?>
                    ...
                    <div class="themecontent">
                        ...
                        <form name="PaymentForm" id="submitsus" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php" target="_blank">
                                    ...
                                    <input type="hidden" name="redirect" value="http://www.readythemes.com/thank-you/"/>
                                    <input type="hidden" name="item_name" value="Ready Themes All Access" />
                                    <div class="buynowbutton" ><a href="#" onclick="document.forms['submitsus'].submit();return false;">Buy now for $47</a></div>
