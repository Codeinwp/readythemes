<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097ff1bf050f29"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/sidebar.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/sidebar_2014-02-07-19.php") )  ) ){
...
<div id="widget">
	...
	<ul>
		<?php $recenblog_query = new WP_Query('cat=-4,-3&showposts=5'); ?>
