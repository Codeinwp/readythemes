<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f052a5b2862"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/page-squirrly.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/page-squirrly_2013-12-15-14.php") )  ) ){
...
<form name="PaymentForm" method="post" id="submitsus" action="http://www.readythemes.com/dap/paypalCoupon.php">
                                    ...
                                    <div><a class="bigbuynow" href="#" onclick="document.forms['submitsus'].submit();return false;">
