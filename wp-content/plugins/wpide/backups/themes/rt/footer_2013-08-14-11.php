<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "1ee8d8c18fb33c50796e77fe1d62401de42864de61"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/footer_2013-08-14-11.php") )  ) ){
...
<div id="footer">
    <div class="container_12">
        ...
        <div class="grid_3">
			...
			<p>
				<a href="/support/">Click here to open a support ticket &raquo;</a>
			</p>
        </div>
        <!-- end footer column 3 -->
...
jQuery(document).ready(function() {
    jQuery('a[href*="jvzoo"]').click(function() {
        _gaq.push(['_trackEvent', 'Click cumpara', 'Cumpara', jQUery(this).attr('href')]);
    });
