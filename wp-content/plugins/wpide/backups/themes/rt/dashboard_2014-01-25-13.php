<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097f4c1fd392d3"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/dashboard.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/dashboard_2014-01-25-13.php") )  ) ){
...
_gaq.push(['_setCustomVar',
      ...
      '<?php echo $user->getId(); ?>',        // The value of the custom variable.  Required parameter.
