<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "bb7a206984d60011e9b5fe89bcea097ff2ddd07c6a"){
                                        if ( file_put_contents ( "/home/readythe/public_html/wp-content/themes/rt/category.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/readythe/public_html/wp-content/plugins/wpide/backups/themes/rt/category_2013-11-28-12.php") )  ) ){
			...
			<?php if ( is_category('4')) { ?>
				...
				<div class="homecontent" style="margin-top:20px;">
					...
					<form name="PaymentForm" method="post" action="http://www.readythemes.com/dap/paypalCoupon.php">
                                    ...
                                    <input type="hidden" name="coupon_code" value="blackfriday">
